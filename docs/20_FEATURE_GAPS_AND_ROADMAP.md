...
| **Clipboard sync** | ◐ spine+host-loop (ADR-076) | All; TeamViewer most granular | **Medium** | **P1** | wire+gate+host enforcement landed (text, per-direction cap, redacted, no-auto-paste); OS backend + app button pending |
