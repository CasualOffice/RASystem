...
|---|---|---|---|---|---|
| **Audio forwarding** | ◐ cap+seam+Opus+host-pump (ADR-077/080) | RustDesk/Parsec Opus; AnyDesk on-by-default | **Low** | **P1** | cap + traits + Opus codec + gated host pump landed; OS capture + transport + playback pending |
