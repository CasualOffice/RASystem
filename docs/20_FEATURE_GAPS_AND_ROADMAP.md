...
|---|---|---|---|---|---|
| **Audio forwarding** | ◐ cap+seam+Opus+host-pump+transport-plane (ADR-077/080) | RustDesk/Parsec Opus; AnyDesk on-by-default | **Low** | **P1** | cap + traits + Opus codec + gated host pump + transport plane (loopback e2e) landed; OS capture + iroh sub-stream + playback pending |
