...
|---|---|---|---|---|---|
| **Audio forwarding** | ◐ cap+seam+Opus codec (ADR-077/080) | RustDesk/Parsec Opus; AnyDesk on-by-default | **Low** | **P1** | `audio.listen` cap + media traits + real Opus codec landed; OS capture + transport + pump pending |
